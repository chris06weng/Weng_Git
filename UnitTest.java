...
public class UnitTest {
    ...
    static void setUpBeforeClass() throws Exception {
        /*
         * Utils.writeStringToFile("junit_example_file_data.txt", "test file
         * contents");
    ...
    void testCreateBlob() throws Exception {
        ...
        // Read file contents
        String indexFileContents = MyUtilityClass.readAFileToAString("objects/" + file1.mexthodToGetSha1());
